import {
  NoSsr,
  Popper
} from "./chunk-ZGXHNUOT.js";
import "./chunk-PKT4HMMJ.js";
import {
  Typography_default
} from "./chunk-O4ZZOM2R.js";
import "./chunk-YZIO7CTK.js";
import "./chunk-FMFFUJ5P.js";
import {
  useTheme
} from "./chunk-KQFEW7CY.js";
import {
  useSlotProps
} from "./chunk-DPPLRE2Z.js";
import {
  require_react_dom
} from "./chunk-ZW7WJ6XU.js";
import {
  Box_default
} from "./chunk-Y4RQOE5P.js";
import "./chunk-7Y3QJ6CF.js";
import {
  init_ownerWindow,
  ...
  useForkRef,
  useId
} from "./chunk-BIHFMXJR.js";
import {
  styled_default
} from "./chunk-RGXIHZKF.js";
import {
  _extends,
...
function ChartsClipPath(props) {
  ...
  return (0, import_jsx_runtime4.jsx)("clipPath", {
    id,
...
function ChartsText(props) {
  ...
  const wordsByLines = React9.useMemo(() => getWordsByLines({
    style,
  ...
  return (0, import_jsx_runtime5.jsx)("text", _extends({}, textProps, {
    ...
    dominantBaseline,
    style,
    children: wordsByLines.map((line, index2) => (0, import_jsx_runtime5.jsx)("tspan", {
      x: x2,
...
function ChartsXReferenceLine(props) {
  ...
  if (xPosition === void 0) {
    if (true) {
      if (!warnedOnce2) {
        warnedOnce2 = true;
        console.error(`MUI X: the value ${x2} does not exist in the data of x axis with id ${axisId}.`);
      }
    }
    return null;
  }
...
function ChartsYReferenceLine(props) {
  ...
  if (yPosition === void 0) {
    if (true) {
      if (!warnedOnce3) {
        warnedOnce3 = true;
        console.error(`MUI X: the value ${y2} does not exist in the data of y axis with id ${axisId}.`);
      }
    }
    return null;
  }
...
function ChartsXAxis(inProps) {
  ...
  const _React$useContext = React14.useContext(CartesianContext), _ref = (_props$axisId = props.axisId) != null ? _props$axisId : xAxisIds[0], {
    xAxis: {
      [_ref]: {
        scale: xScale,
        tickNumber,
...
function ChartsYAxis(inProps) {
  ...
  const _React$useContext = React15.useContext(CartesianContext), _ref = (_props$axisId = props.axisId) != null ? _props$axisId : yAxisIds[0], {
    yAxis: {
      [_ref]: {
        scale: yScale,
        tickNumber
...
true ? ChartsAxis.propTypes = {
   ...
   */
  bottomAxis: import_prop_types8.default.oneOfType([import_prop_types8.default.shape({
   ...
   */
  leftAxis: import_prop_types8.default.oneOfType([import_prop_types8.default.shape({
    axisId: import_prop_types8.default.oneOfType([import_prop_types8.default.number, import_prop_types8.default.string]),
    classes: import_prop_types8.default.object,
    disableLine: import_prop_types8.default.bool,
    disableTicks: import_prop_types8.default.bool,
   ...
   * @default null
   */
  rightAxis: import_prop_types8.default.oneOfType([import_prop_types8.default.shape({
    axisId: import_prop_types8.default.oneOfType([import_prop_types8.default.number, import_prop_types8.default.string]),
    classes: import_prop_types8.default.object,
    disableLine: import_prop_types8.default.bool,
    disableTicks: import_prop_types8.default.bool,
   ...
   * @default null
   */
  topAxis: import_prop_types8.default.oneOfType([import_prop_types8.default.shape({
    axisId: import_prop_types8.default.oneOfType([import_prop_types8.default.number, import_prop_types8.default.string]),
    classes: import_prop_types8.default.object,
    disableLine: import_prop_types8.default.bool,
    disableTicks: import_prop_types8.default.bool,
...
var InteractionContext = React17.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React17.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
  ...
  const value = React17.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
  return (0, import_jsx_runtime17.jsx)(InteractionContext.Provider, {
    value,
    children
  });
}
...
function useMouseTracker() {
  const svgRef = React18.useContext(SVGContext);
  const [mousePosition, setMousePosition] = React18.useState(null);
  React18.useEffect(() => {
...
true ? ChartsItemTooltipContent.propTypes = {
  ...
  contentProps: import_prop_types10.default.shape({
    ...
    series: import_prop_types10.default.shape({
      color: import_prop_types10.default.string,
      data: import_prop_types10.default.oneOfType([import_prop_types10.default.arrayOf(import_prop_types10.default.number), import_prop_types10.default.arrayOf(import_prop_types10.default.number), import_prop_types10.default.arrayOf(import_prop_types10.default.shape({
        ...
        x: import_prop_types10.default.number.isRequired,
        y: import_prop_types10.default.number.isRequired
      })), import_prop_types10.default.arrayOf(import_prop_types10.default.shape({
        color: import_prop_types10.default.string.isRequired,
        endAngle: import_prop_types10.default.number.isRequired,
        formattedValue: import_prop_types10.default.string.isRequired,
        id: import_prop_types10.default.oneOfType([import_prop_types10.default.number, import_prop_types10.default.string]).isRequired,
        index: import_prop_types10.default.number.isRequired,
        label: import_prop_types10.default.string,
        padAngle: import_prop_types10.default.number.isRequired,
      ...
      id: import_prop_types10.default.oneOfType([import_prop_types10.default.number, import_prop_types10.default.string]).isRequired,
      type: import_prop_types10.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired,
      valueFormatter: import_prop_types10.default.func.isRequired
    }),
    ...
    children: (0, import_jsx_runtime22.jsxs)(ChartsTooltipTable, {
      ...
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime21.jsx)("thead", {
        ...
        children: series.map(({
          ...
          return (0, import_jsx_runtime22.jsxs)(ChartsTooltipRow, {
            className: classes.row,
            children: [(0, import_jsx_runtime21.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.markCell, classes.cell),
              children: (0, import_jsx_runtime21.jsx)(ChartsTooltipMark, {
                ownerState: {
                  color: color2
                },
                boxShadow: 1,
              ...
              className: clsx_default(classes.labelCell, classes.cell),
              children: label ? (0, import_jsx_runtime21.jsx)(Typography_default, {
                children: label
              }) : null
            }), (0, import_jsx_runtime21.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.valueCell, classes.cell),
...
true ? DefaultChartsAxisTooltipContent.propTypes = {
   ...
   */
  axisValue: import_prop_types11.default.any.isRequired,
  /**
   * Override or extend the styles applied to the component.
   */
...
function ChartsAxisTooltipContent(props) {
  ...
  return (0, import_jsx_runtime23.jsx)(Content, _extends({}, chartTooltipContentProps));
}
true ? ChartsAxisTooltipContent.propTypes = {
  ...
  contentProps: import_prop_types12.default.shape({
    ...
    axisValue: import_prop_types12.default.any,
...
function ChartsTooltip(props) {
  ...
  return (0, import_jsx_runtime24.jsx)(NoSsr, {
    children: popperOpen && (0, import_jsx_runtime24.jsx)(PopperComponent, _extends({}, popperProps, {
      children: trigger === "item" ? (0, import_jsx_runtime24.jsx)(ChartsItemTooltipContent, {
        ...
        classes
      }) : (0, import_jsx_runtime24.jsx)(ChartsAxisTooltipContent, {
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime26.jsxs)(React24.Fragment, {
    children: [xAxisHighlight === "band" && axis.x !== null && isBandScale(xScale) && (0, import_jsx_runtime25.jsx)(ChartsAxisHighlightPath, {
    ...
    }), yAxisHighlight === "band" && axis.y !== null && isBandScale(yScale) && (0, import_jsx_runtime25.jsx)(ChartsAxisHighlightPath, {
...
var HighlighContext = React28.createContext({
  item: null,
  scope: defaultScope,
  dispatch: () => null
});
...
function HighlightProvider(props) {
  ...
  const [data, dispatch] = React28.useReducer(dataReducer2, {
    item: null,
    scope: defaultScope
  });
  const value = React28.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
  return (0, import_jsx_runtime27.jsx)(HighlighContext.Provider, {
    value,
    children
  });
}
...
var _excluded5 = ["id", "dataIndex", "classes", "color", "highlightScope", "slots", "slotProps", "style"];
...
function BarElement(props) {
  ...
  return (0, import_jsx_runtime28.jsx)(Bar, _extends({}, barProps));
}
...
var useCompletedData = () => {
  ...
  const seriesData = (_React$useContext$bar = React31.useContext(SeriesContext).bar) != null ? _React$useContext$bar : {
    series: {},
    stackingGroups: [],
    seriesOrder: []
  };
  const axisData = React31.useContext(CartesianContext);
  const {
    series,
    stackingGroups
  } = seriesData;
...
function BarPlot(props) {
  ...
  return (0, import_jsx_runtime29.jsx)(React31.Fragment, {
    children: transition((style, {
      seriesId,
      dataIndex,
      color: color2,
      highlightScope
    }) => (0, import_jsx_runtime29.jsx)(BarElement, _extends({
      id: seriesId,
      dataIndex,
      highlightScope,
      color: color2
...
var useAxisEvents = (disableAxisListener) => {
  const svgRef = React32.useContext(SVGContext);
  const {
    width,
    height,
    top,
...
var _excluded7 = ["children", "width", "height", "viewBox", "disableAxisListener", "className"];
var ChartChartsSurfaceStyles = styled_default("svg", {
  name: "MuiChartsSurface",
  slot: "Root"
})(() => ({}));
var ChartsSurface = React33.forwardRef(function ChartsSurface2(props, ref) {
  const {
    children,
    width,
    height,
  ...
  return (0, import_jsx_runtime31.jsxs)(ChartChartsSurfaceStyles, _extends({
    width,
    height,
    viewBox: `${svgView.x} ${svgView.y} ${svgView.width} ${svgView.height}`,
    ref
  }, other, {
    children: [(0, import_jsx_runtime30.jsx)("title", {
      children: props.title
    }), (0, import_jsx_runtime30.jsx)("desc", {
      children: props.desc
    }), children]
  }));
});
...
var ChartContainer = React34.forwardRef(function ChartContainer2(props, ref) {
  const {
    width,
    height,
    series,
  ...
  const svgRef = React34.useRef(null);
  const handleRef = useForkRef(ref, svgRef);
  useReducedMotion2();
  return (0, import_jsx_runtime32.jsx)(DrawingProvider, {
    width,
    height,
    margin,
    svgRef,
    children: (0, import_jsx_runtime32.jsx)(SeriesContextProvider, {
      series,
      colors: colors3,
      dataset,
      children: (0, import_jsx_runtime32.jsx)(CartesianContextProvider, {
        xAxis,
        yAxis,
        dataset,
        children: (0, import_jsx_runtime32.jsx)(InteractionProvider, {
          children: (0, import_jsx_runtime32.jsx)(HighlightProvider, {
            children: (0, import_jsx_runtime32.jsx)(ChartsSurface, {
              width,
              height,
              ref: handleRef,
              sx,
...
var useChartDimensions2 = (inWidth, inHeight) => {
  ...
  const [height, setHeight] = React35.useState(0);
...
var ResponsiveChartContainer = React35.forwardRef(function ResponsiveChartContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime33.jsx)(ResizableContainer, {
    ref: containerRef,
    ownerState: {
      width: inWidth,
      height: inHeight
    },
    children: width && height ? (0, import_jsx_runtime33.jsx)(ChartContainer, _extends({}, other, {
      width,
      height,
      ref
    })) : null
...
function DefaultChartsLegend(props) {
  ...
  const theme = useTheme();
  const labelStyle = React36.useMemo(
  ...
  const padding = React36.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React36.useCallback((label, inStyle = {}) => {
  ...
  const seriesWithPosition = React36.useMemo(() => {
    let x2 = 0;
    let y2 = 0;
  ...
  return (0, import_jsx_runtime34.jsx)(NoSsr, {
    children: (0, import_jsx_runtime34.jsx)(ChartsLegendRoot, {
      className: classes.root,
...
function ChartsLegend(inProps) {
  ...
  const drawingArea = React36.useContext(DrawingContext);
  const series = React36.useContext(SeriesContext);
  ...
  return (0, import_jsx_runtime34.jsx)(ChartLegendRender, _extends({}, chartLegendRenderProps));
}
...
var BarChart = React37.forwardRef(function BarChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
  ...
  const defaultAxisConfig = {
    scaleType: "band",
    data: Array.from({
      length: Math.max(...series.map((s2) => {
        var _ref, _s$data;
        return ((_ref = (_s$data = s2.data) != null ? _s$data : dataset) != null ? _ref : []).length;
      }))
    }, (_, index2) => index2)
  };
  ...
  return (0, import_jsx_runtime37.jsxs)(ResponsiveChartContainer, {
    ...
    children: [(0, import_jsx_runtime36.jsx)("g", {
      ...
      children: (0, import_jsx_runtime36.jsx)(BarPlot, {
        slots,
        slotProps,
        skipAnimation: skipAnimation2
      })
    }), (0, import_jsx_runtime36.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      ...
      slots,
      slotProps
    })), (0, import_jsx_runtime36.jsx)(ChartsAxisHighlight, _extends({}, defaultizedAxisHighlight)), (0, import_jsx_runtime36.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
    })), (0, import_jsx_runtime36.jsx)(ChartsClipPath, {
      id: clipPathId
    }), children]
  });
});
true ? BarChart.propTypes = {
   ...
   * @default xAxisIds[0] The id of the first provided axis
   */
  bottomAxis: import_prop_types19.default.oneOfType([import_prop_types19.default.shape({
  ...
  layout: import_prop_types19.default.oneOf(["horizontal", "vertical"]),
  /**
   * Indicate which axis to display the left of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default yAxisIds[0] The id of the first provided axis
   */
  leftAxis: import_prop_types19.default.oneOfType([import_prop_types19.default.shape({
    axisId: import_prop_types19.default.oneOfType([import_prop_types19.default.number, import_prop_types19.default.string]),
    classes: import_prop_types19.default.object,
    disableLine: import_prop_types19.default.bool,
    disableTicks: import_prop_types19.default.bool,
   ...
   */
  legend: import_prop_types19.default.shape({
    classes: import_prop_types19.default.object,
   ...
   * @default null
   */
  rightAxis: import_prop_types19.default.oneOfType([import_prop_types19.default.shape({
    axisId: import_prop_types19.default.oneOfType([import_prop_types19.default.number, import_prop_types19.default.string]),
    classes: import_prop_types19.default.object,
    disableLine: import_prop_types19.default.bool,
    disableTicks: import_prop_types19.default.bool,
  ...
  series: import_prop_types19.default.arrayOf(import_prop_types19.default.shape({
    color: import_prop_types19.default.string,
    data: import_prop_types19.default.arrayOf(import_prop_types19.default.number),
    ...
    label: import_prop_types19.default.string,
    layout: import_prop_types19.default.oneOf(["horizontal", "vertical"]),
    stack: import_prop_types19.default.string,
    stackOffset: import_prop_types19.default.oneOf(["diverging", "expand", "none", "silhouette", "wiggle"]),
    stackOrder: import_prop_types19.default.oneOf(["appearance", "ascending", "descending", "insideOut", "none", "reverse"]),
    type: import_prop_types19.default.oneOf(["bar"]),
    valueFormatter: import_prop_types19.default.func,
    xAxisKey: import_prop_types19.default.string,
    yAxisKey: import_prop_types19.default.string
  })).isRequired,
  /**
   * If `true`, animations are skiped.
   * @default false
  ...
  tooltip: import_prop_types19.default.shape({
    axisContent: import_prop_types19.default.elementType,
    classes: import_prop_types19.default.object,
    itemContent: import_prop_types19.default.elementType,
    slotProps: import_prop_types19.default.object,
    slots: import_prop_types19.default.object,
   ...
   * @default null
   */
  topAxis: import_prop_types19.default.oneOfType([import_prop_types19.default.shape({
    axisId: import_prop_types19.default.oneOfType([import_prop_types19.default.number, import_prop_types19.default.string]),
    classes: import_prop_types19.default.object,
    disableLine: import_prop_types19.default.bool,
    disableTicks: import_prop_types19.default.bool,
  ...
  xAxis: import_prop_types19.default.arrayOf(import_prop_types19.default.shape({
    ...
    position: import_prop_types19.default.oneOf(["bottom", "left", "right", "top"]),
...
var _excluded10 = ["id", "classes", "color", "highlightScope", "slots", "slotProps"];
...
AreaElementPath.propTypes = {
  ...
  ownerState: import_prop_types20.default.shape({
...
function AreaElement(props) {
  ...
  return (0, import_jsx_runtime38.jsx)(Area, _extends({}, areaProps));
}
...
function AreaPlot(props) {
  ...
  const seriesData = React39.useContext(SeriesContext).line;
  const axisData = React39.useContext(CartesianContext);
  ...
  const defaultXAxisId = xAxisIds[0];
  const defaultYAxisId = yAxisIds[0];
  return (0, import_jsx_runtime39.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        const formattedData = (_xData$map = xData == null ? void 0 : xData.map((x2, index2) => ({
          x: x2,
          y: stackedData[index2]
        }))) != null ? _xData$map : [];
        const d3Data = connectNulls ? formattedData.filter((_, i) => data[i] != null) : formattedData;
        return !!series[seriesId].area && (0, import_jsx_runtime39.jsx)(AreaElement, {
          id: seriesId,
...
var _excluded12 = ["id", "classes", "color", "highlightScope", "slots", "slotProps"];
...
LineElementPath.propTypes = {
  ...
  ownerState: import_prop_types22.default.shape({
...
function LineElement(props) {
  ...
  const {
    item
  } = React40.useContext(InteractionContext);
  const isHighlighted = getIsHighlighted(item, {
    type: "line",
    seriesId: id
  }, highlightScope);
  ...
  return (0, import_jsx_runtime40.jsx)(Line, _extends({}, lineProps));
}
...
function LinePlot(props) {
  ...
  const seriesData = React41.useContext(SeriesContext).line;
  const axisData = React41.useContext(CartesianContext);
  if (seriesData === void 0) {
    return null;
  }
  const {
  ...
  return (0, import_jsx_runtime41.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        const d3Data = connectNulls ? formattedData.filter((_, i) => data[i] != null) : formattedData;
        return (0, import_jsx_runtime41.jsx)(LineElement, {
          id: seriesId,
...
var _excluded14 = ["x", "y", "id", "classes", "color", "shape", "dataIndex", "highlightScope"];
...
MarkElementPath.propTypes = {
  ...
  ownerState: import_prop_types24.default.shape({
    classes: import_prop_types24.default.object,
    color: import_prop_types24.default.string.isRequired,
    id: import_prop_types24.default.string.isRequired,
    isFaded: import_prop_types24.default.bool.isRequired,
    isHighlighted: import_prop_types24.default.bool.isRequired,
    x: import_prop_types24.default.number.isRequired,
    y: import_prop_types24.default.number.isRequired
  }).isRequired,
...
function MarkElement(props) {
  ...
  return (0, import_jsx_runtime42.jsx)(MarkElementPath, _extends({}, other, {
    ownerState,
    className: classes.root,
...
true ? MarkElement.propTypes = {
   ...
   */
  shape: import_prop_types24.default.oneOf(["circle", "cross", "diamond", "square", "star", "triangle", "wye"]).isRequired
} : void 0;
...
function MarkPlot(props) {
  ...
  const seriesData = React43.useContext(SeriesContext).line;
  ...
  const defaultXAxisId = xAxisIds[0];
  const defaultYAxisId = yAxisIds[0];
  return (0, import_jsx_runtime43.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ids: groupIds
    }) => {
      return groupIds.flatMap((seriesId) => {
        ...
        return xData == null ? void 0 : xData.map((x2, index2) => {
          ...
          return (0, import_jsx_runtime43.jsx)(Mark, _extends({
            id: seriesId,
            dataIndex: index2,
            shape: "circle",
            color: series[seriesId].color,
...
var _excluded16 = ["x", "y", "id", "classes", "color"];
...
function LineHighlightElement(props) {
  ...
  return (0, import_jsx_runtime44.jsx)(HighlightElement, _extends({}, other, {
    ownerState,
    className: classes.root,
    cx: 0,
    cy: 0,
...
function LineHighlightPlot(props) {
  ...
  const seriesData = React45.useContext(SeriesContext).line;
  const axisData = React45.useContext(CartesianContext);
  const {
    axis
  ...
  return (0, import_jsx_runtime45.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        return (0, import_jsx_runtime45.jsx)(Element, _extends({
          id: seriesId,
          color: series[seriesId].color,
          x: x2,
          y: y2
...
var LineChart = React46.forwardRef(function LineChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
  ...
  const id = useId();
  const clipPathId = `${id}-clip-path`;
  return (0, import_jsx_runtime47.jsxs)(ResponsiveChartContainer, {
    ref,
    series: series.map((s2) => _extends({
    ...
    sx,
    disableAxisListener: (tooltip == null ? void 0 : tooltip.trigger) !== "axis" && (axisHighlight == null ? void 0 : axisHighlight.x) === "none" && (axisHighlight == null ? void 0 : axisHighlight.y) === "none",
    children: [(0, import_jsx_runtime47.jsxs)("g", {
      clipPath: `url(#${clipPathId})`,
      children: [(0, import_jsx_runtime46.jsx)(AreaPlot, {
        slots,
        slotProps
      }), (0, import_jsx_runtime46.jsx)(LinePlot, {
        slots,
        slotProps
      })]
    }), (0, import_jsx_runtime46.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), (0, import_jsx_runtime46.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), (0, import_jsx_runtime46.jsx)(MarkPlot, {
      slots,
      slotProps
    }), (0, import_jsx_runtime46.jsx)(LineHighlightPlot, {
      slots,
      slotProps
    }), (0, import_jsx_runtime46.jsx)(ChartsLegend, _extends({}, legend, {
      slots,
      slotProps
    })), (0, import_jsx_runtime46.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
    })), (0, import_jsx_runtime46.jsx)(ChartsClipPath, {
      id: clipPathId
    }), children]
  });
});
true ? LineChart.propTypes = {
   ...
   * @default { x: 'line' }
   */
  axisHighlight: import_prop_types28.default.shape({
    x: import_prop_types28.default.oneOf(["band", "line", "none"]),
    y: import_prop_types28.default.oneOf(["band", "line", "none"])
  }),
  /**
   * Indicate which axis to display the bottom of the charts.
   * Can be a string (the id of the axis) or an object `ChartsXAxisProps`.
   * @default xAxisIds[0] The id of the first provided axis
   */
  bottomAxis: import_prop_types28.default.oneOfType([import_prop_types28.default.shape({
    axisId: import_prop_types28.default.oneOfType([import_prop_types28.default.number, import_prop_types28.default.string]),
    classes: import_prop_types28.default.object,
    disableLine: import_prop_types28.default.bool,
    disableTicks: import_prop_types28.default.bool,
    fill: import_prop_types28.default.string,
    label: import_prop_types28.default.string,
    labelFontSize: import_prop_types28.default.number,
    labelStyle: import_prop_types28.default.object,
    position: import_prop_types28.default.oneOf(["bottom", "top"]),
    slotProps: import_prop_types28.default.object,
    slots: import_prop_types28.default.object,
    stroke: import_prop_types28.default.string,
    tickFontSize: import_prop_types28.default.number,
    tickInterval: import_prop_types28.default.oneOfType([import_prop_types28.default.oneOf(["auto"]), import_prop_types28.default.array, import_prop_types28.default.func]),
    tickLabelInterval: import_prop_types28.default.oneOfType([import_prop_types28.default.oneOf(["auto"]), import_prop_types28.default.func]),
    tickLabelStyle: import_prop_types28.default.object,
    tickMaxStep: import_prop_types28.default.number,
    tickMinStep: import_prop_types28.default.number,
    tickNumber: import_prop_types28.default.number,
    tickSize: import_prop_types28.default.number
   ...
   * @default blueberryTwilightPalette
   */
  colors: import_prop_types28.default.oneOfType([import_prop_types28.default.arrayOf(import_prop_types28.default.string), import_prop_types28.default.func]),
  /**
   * An array of objects that can be used to populate series and axes data using their `dataKey` property.
   */
  dataset: import_prop_types28.default.arrayOf(import_prop_types28.default.object),
   ...
   */
  disableLineItemHighlight: import_prop_types28.default.bool,
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   * @default undefined
   */
   ...
   * @default yAxisIds[0] The id of the first provided axis
   */
  leftAxis: import_prop_types28.default.oneOfType([import_prop_types28.default.shape({
    axisId: import_prop_types28.default.oneOfType([import_prop_types28.default.number, import_prop_types28.default.string]),
    classes: import_prop_types28.default.object,
    disableLine: import_prop_types28.default.bool,
    disableTicks: import_prop_types28.default.bool,
    ...
    labelFontSize: import_prop_types28.default.number,
    labelStyle: import_prop_types28.default.object,
    position: import_prop_types28.default.oneOf(["left", "right"]),
    slotProps: import_prop_types28.default.object,
    slots: import_prop_types28.default.object,
    stroke: import_prop_types28.default.string,
    tickFontSize: import_prop_types28.default.number,
   ...
   * @deprecated Consider using `slotProps.legend` instead.
   */
  legend: import_prop_types28.default.shape({
    classes: import_prop_types28.default.object,
    direction: import_prop_types28.default.oneOf(["column", "row"]),
    hidden: import_prop_types28.default.bool,
    position: import_prop_types28.default.shape({
      horizontal: import_prop_types28.default.oneOf(["left", "middle", "right"]).isRequired,
      vertical: import_prop_types28.default.oneOf(["bottom", "middle", "top"]).isRequired
    }),
    slotProps: import_prop_types28.default.object,
    slots: import_prop_types28.default.object
  }),
   ...
   * @default null
   */
  rightAxis: import_prop_types28.default.oneOfType([import_prop_types28.default.shape({
    axisId: import_prop_types28.default.oneOfType([import_prop_types28.default.number, import_prop_types28.default.string]),
    classes: import_prop_types28.default.object,
    disableLine: import_prop_types28.default.bool,
    disableTicks: import_prop_types28.default.bool,
  ...
  series: import_prop_types28.default.arrayOf(import_prop_types28.default.shape({
    area: import_prop_types28.default.bool,
    color: import_prop_types28.default.string,
    connectNulls: import_prop_types28.default.bool,
    curve: import_prop_types28.default.oneOf(["catmullRom", "linear", "monotoneX", "monotoneY", "natural", "step", "stepAfter", "stepBefore"]),
    data: import_prop_types28.default.arrayOf(import_prop_types28.default.number),
    dataKey: import_prop_types28.default.string,
    disableHighlight: import_prop_types28.default.bool,
    highlightScope: import_prop_types28.default.shape({
      faded: import_prop_types28.default.oneOf(["global", "none", "series"]),
      highlighted: import_prop_types28.default.oneOf(["item", "none", "series"])
    }),
    id: import_prop_types28.default.oneOfType([import_prop_types28.default.number, import_prop_types28.default.string]),
    label: import_prop_types28.default.string,
    showMark: import_prop_types28.default.oneOfType([import_prop_types28.default.func, import_prop_types28.default.bool]),
    stack: import_prop_types28.default.string,
    stackOffset: import_prop_types28.default.oneOf(["diverging", "expand", "none", "silhouette", "wiggle"]),
    stackOrder: import_prop_types28.default.oneOf(["appearance", "ascending", "descending", "insideOut", "none", "reverse"]),
    type: import_prop_types28.default.oneOf(["line"]),
    valueFormatter: import_prop_types28.default.func,
    xAxisKey: import_prop_types28.default.string,
    yAxisKey: import_prop_types28.default.string
  })).isRequired,
  /**
   * The props used for each component slot.
   * @default {}
  ...
  tooltip: import_prop_types28.default.shape({
    axisContent: import_prop_types28.default.elementType,
    classes: import_prop_types28.default.object,
    itemContent: import_prop_types28.default.elementType,
    slotProps: import_prop_types28.default.object,
    slots: import_prop_types28.default.object,
    trigger: import_prop_types28.default.oneOf(["axis", "item", "none"])
  }),
  /**
   * Indicate which axis to display the top of the charts.
   * Can be a string (the id of the axis) or an object `ChartsXAxisProps`.
   * @default null
   */
  topAxis: import_prop_types28.default.oneOfType([import_prop_types28.default.shape({
    axisId: import_prop_types28.default.oneOfType([import_prop_types28.default.number, import_prop_types28.default.string]),
    classes: import_prop_types28.default.object,
    disableLine: import_prop_types28.default.bool,
    disableTicks: import_prop_types28.default.bool,
   ...
   * If not provided, a default axis config is used with id set to `DEFAULT_X_AXIS_KEY`.
   */
  xAxis: import_prop_types28.default.arrayOf(import_prop_types28.default.shape({
    axisId: import_prop_types28.default.oneOfType([import_prop_types28.default.number, import_prop_types28.default.string]),
    classes: import_prop_types28.default.object,
    data: import_prop_types28.default.array,
    dataKey: import_prop_types28.default.string,
    disableLine: import_prop_types28.default.bool,
    disableTicks: import_prop_types28.default.bool,
    fill: import_prop_types28.default.string,
    hideTooltip: import_prop_types28.default.bool,
    id: import_prop_types28.default.oneOfType([import_prop_types28.default.number, import_prop_types28.default.string]),
    label: import_prop_types28.default.string,
    labelFontSize: import_prop_types28.default.number,
    labelStyle: import_prop_types28.default.object,
    max: import_prop_types28.default.oneOfType([import_prop_types28.default.instanceOf(Date), import_prop_types28.default.number]),
    min: import_prop_types28.default.oneOfType([import_prop_types28.default.instanceOf(Date), import_prop_types28.default.number]),
    position: import_prop_types28.default.oneOf(["bottom", "left", "right", "top"]),
    reverse: import_prop_types28.default.bool,
    scaleType: import_prop_types28.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types28.default.object,
    slots: import_prop_types28.default.object,
    stroke: import_prop_types28.default.string,
    tickFontSize: import_prop_types28.default.number,
   ...
   * If not provided, a default axis config is used with id set to `DEFAULT_Y_AXIS_KEY`.
   */
  yAxis: import_prop_types28.default.arrayOf(import_prop_types28.default.shape({
    axisId: import_prop_types28.default.oneOfType([import_prop_types28.default.number, import_prop_types28.default.string]),
    classes: import_prop_types28.default.object,
    data: import_prop_types28.default.array,
    dataKey: import_prop_types28.default.string,
...
var _excluded18 = ["id", "dataIndex", "classes", "color", "highlightScope", "onClick", "isFaded", "isHighlighted", "startAngle", "endAngle", "paddingAngle", "innerRadius", "outerRadius", "cornerRadius"];
...
function PieArc(props) {
  ...
  const getInteractionItemProps = useInteractionItemProps(highlightScope);
  return (0, import_jsx_runtime48.jsx)(PieArcRoot, _extends({
...
function useTransformData(series) {
  ...
  } = React48.useContext(InteractionContext);
  const getHighlightStatus = React48.useCallback((dataIndex) => {
  ...
  const dataWithHighlight = React48.useMemo(() => data.map((item, itemIndex) => {
...
var _excluded19 = ["slots", "slotProps", "innerRadius", "outerRadius", "cornerRadius", "paddingAngle", "id", "highlightScope", "highlighted", "faded", "data", "onClick", "skipAnimation"];
...
function PieArcPlot(props) {
  ...
  return (0, import_jsx_runtime49.jsx)("g", _extends({}, other, {
    children: transition((_ref, item, _, index2) => {
      ...
      return (0, import_jsx_runtime49.jsx)(Arc, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
true ? PieArcPlot.propTypes = {
   ...
   */
  arcLabelRadius: import_prop_types30.default.number,
  /**
   * The radius applied to arc corners (similar to border radius).
   * @default 0
   */
  cornerRadius: import_prop_types30.default.number,
  data: import_prop_types30.default.arrayOf(import_prop_types30.default.shape({
    color: import_prop_types30.default.string.isRequired,
    endAngle: import_prop_types30.default.number.isRequired,
    formattedValue: import_prop_types30.default.string.isRequired,
    ...
    index: import_prop_types30.default.number.isRequired,
    label: import_prop_types30.default.string,
    padAngle: import_prop_types30.default.number.isRequired,
    startAngle: import_prop_types30.default.number.isRequired,
   ...
   */
  faded: import_prop_types30.default.shape({
    additionalRadius: import_prop_types30.default.number,
    arcLabelRadius: import_prop_types30.default.number,
    color: import_prop_types30.default.string,
    cornerRadius: import_prop_types30.default.number,
    innerRadius: import_prop_types30.default.number,
    outerRadius: import_prop_types30.default.number,
    paddingAngle: import_prop_types30.default.number
  }),
  /**
   * Override the arc attibutes when it is highlighted.
   */
  highlighted: import_prop_types30.default.shape({
    additionalRadius: import_prop_types30.default.number,
    arcLabelRadius: import_prop_types30.default.number,
    color: import_prop_types30.default.string,
    cornerRadius: import_prop_types30.default.number,
  ...
  highlightScope: import_prop_types30.default.shape({
    faded: import_prop_types30.default.oneOf(["global", "none", "series"]),
    highlighted: import_prop_types30.default.oneOf(["item", "none", "series"])
  }),
  id: import_prop_types30.default.oneOfType([import_prop_types30.default.number, import_prop_types30.default.string]).isRequired,
  /**
   ...
   */
  outerRadius: import_prop_types30.default.number.isRequired,
  /**
...
var _excluded20 = ["id", "classes", "color", "startAngle", "endAngle", "paddingAngle", "arcLabelRadius", "innerRadius", "outerRadius", "cornerRadius", "formattedArcLabel", "isHighlighted", "isFaded", "style"];
...
function PieArcLabel(props) {
  ...
  return (0, import_jsx_runtime50.jsx)(PieArcLabelRoot, _extends({
    className: classes.root
  }, other, {
    style: _extends({
...
true ? PieArcLabel.propTypes = {
  ...
  formattedArcLabel: import_prop_types31.default.string,
...
var _excluded21 = ["slots", "slotProps", "innerRadius", "outerRadius", "arcLabelRadius", "cornerRadius", "paddingAngle", "id", "highlightScope", "highlighted", "faded", "data", "arcLabel", "arcLabelMinAngle", "skipAnimation"];
...
function PieArcLabelPlot(props) {
  ...
  return (0, import_jsx_runtime51.jsx)("g", _extends({}, other, {
    children: transition((_ref, item) => {
      ...
      return (0, import_jsx_runtime51.jsx)(ArcLabel, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
true ? PieArcLabelPlot.propTypes = {
   ...
   */
  arcLabel: import_prop_types32.default.oneOfType([import_prop_types32.default.oneOf(["formattedValue", "label", "value"]), import_prop_types32.default.func]),
  /**
   * The minimal angle required to display the arc label.
   * @default 0
   */
  arcLabelMinAngle: import_prop_types32.default.number,
  /**
   * The radius between circle center and the arc label in px.
   * @default (innerRadius - outerRadius) / 2
   */
  arcLabelRadius: import_prop_types32.default.number,
  /**
   * The radius applied to arc corners (similar to border radius).
   * @default 0
   */
  cornerRadius: import_prop_types32.default.number,
  data: import_prop_types32.default.arrayOf(import_prop_types32.default.shape({
    ...
    endAngle: import_prop_types32.default.number.isRequired,
    formattedValue: import_prop_types32.default.string.isRequired,
    ...
    index: import_prop_types32.default.number.isRequired,
    label: import_prop_types32.default.string,
    padAngle: import_prop_types32.default.number.isRequired,
    startAngle: import_prop_types32.default.number.isRequired,
   ...
   * @default { additionalRadius: -5 }
   */
  faded: import_prop_types32.default.shape({
    additionalRadius: import_prop_types32.default.number,
    arcLabelRadius: import_prop_types32.default.number,
    color: import_prop_types32.default.string,
    cornerRadius: import_prop_types32.default.number,
    innerRadius: import_prop_types32.default.number,
    outerRadius: import_prop_types32.default.number,
    paddingAngle: import_prop_types32.default.number
  }),
  /**
   * Override the arc attibutes when it is highlighted.
   */
  highlighted: import_prop_types32.default.shape({
    additionalRadius: import_prop_types32.default.number,
    arcLabelRadius: import_prop_types32.default.number,
    color: import_prop_types32.default.string,
    cornerRadius: import_prop_types32.default.number,
   ...
   * The radius between circle center and the end of the arc.
   */
  outerRadius: import_prop_types32.default.number.isRequired,
  /**
   * The padding angle (deg) between two arcs.
   * @default 0
   */
...
function PiePlot(props) {
  ...
  const seriesData = React52.useContext(SeriesContext).pie;
  const {
    left,
    top,
    width,
    height
  } = React52.useContext(DrawingContext);
  if (seriesData === void 0) {
    return null;
  }
  ...
  return (0, import_jsx_runtime53.jsxs)("g", {
    children: [seriesOrder.map((seriesId) => {
      ...
      return (0, import_jsx_runtime52.jsx)("g", {
        transform: `translate(${left + cx}, ${top + cy})`,
        children: (0, import_jsx_runtime52.jsx)(PieArcPlot, {
          innerRadius,
          outerRadius,
          cornerRadius,
          paddingAngle,
      ...
      return (0, import_jsx_runtime52.jsx)("g", {
        transform: `translate(${left + cx}, ${top + cy})`,
        children: (0, import_jsx_runtime52.jsx)(PieArcLabelPlot, {
          innerRadius,
...
function PieChart(props) {
  ...
  return (0, import_jsx_runtime55.jsxs)(ResponsiveChartContainer, {
    series: series.map((s2) => _extends({
      type: "pie"
    }, s2)),
    width,
    ...
    sx,
    disableAxisListener: (tooltip == null ? void 0 : tooltip.trigger) !== "axis" && (axisHighlight == null ? void 0 : axisHighlight.x) === "none" && (axisHighlight == null ? void 0 : axisHighlight.y) === "none",
    children: [(0, import_jsx_runtime54.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), (0, import_jsx_runtime54.jsx)(PiePlot, {
      slots,
      slotProps,
      onClick,
      skipAnimation: skipAnimation2
      ...
      slots,
      slotProps
    })), (0, import_jsx_runtime54.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), (0, import_jsx_runtime54.jsx)(ChartsTooltip, _extends({}, tooltip)), children]
  });
}
true ? PieChart.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "yarn proptypes"  |
  // ----------------------------------------------------------------------
  axisHighlight: import_prop_types34.default.shape({
    x: import_prop_types34.default.oneOf(["band", "line", "none"]),
    y: import_prop_types34.default.oneOf(["band", "line", "none"])
  }),
  /**
   * Indicate which axis to display the bottom of the charts.
   * Can be a string (the id of the axis) or an object `ChartsXAxisProps`.
   * @default null
   */
  bottomAxis: import_prop_types34.default.oneOfType([import_prop_types34.default.shape({
    axisId: import_prop_types34.default.oneOfType([import_prop_types34.default.number, import_prop_types34.default.string]),
    classes: import_prop_types34.default.object,
    disableLine: import_prop_types34.default.bool,
    disableTicks: import_prop_types34.default.bool,
    fill: import_prop_types34.default.string,
    label: import_prop_types34.default.string,
    labelFontSize: import_prop_types34.default.number,
    labelStyle: import_prop_types34.default.object,
    position: import_prop_types34.default.oneOf(["bottom", "top"]),
    slotProps: import_prop_types34.default.object,
    slots: import_prop_types34.default.object,
    stroke: import_prop_types34.default.string,
    tickFontSize: import_prop_types34.default.number,
    tickInterval: import_prop_types34.default.oneOfType([import_prop_types34.default.oneOf(["auto"]), import_prop_types34.default.array, import_prop_types34.default.func]),
    tickLabelInterval: import_prop_types34.default.oneOfType([import_prop_types34.default.oneOf(["auto"]), import_prop_types34.default.func]),
    tickLabelStyle: import_prop_types34.default.object,
    tickMaxStep: import_prop_types34.default.number,
    tickMinStep: import_prop_types34.default.number,
    tickNumber: import_prop_types34.default.number,
    tickSize: import_prop_types34.default.number
   ...
   * @default blueberryTwilightPalette
   */
  colors: import_prop_types34.default.oneOfType([import_prop_types34.default.arrayOf(import_prop_types34.default.string), import_prop_types34.default.func]),
  /**
   * An array of objects that can be used to populate series and axes data using their `dataKey` property.
   */
  dataset: import_prop_types34.default.arrayOf(import_prop_types34.default.object),
  desc: import_prop_types34.default.string,
  /**
   * If `true`, the charts will not listen to the mouse move event.
   * It might break interactive features, but will improve performance.
   * @default false
   */
  disableAxisListener: import_prop_types34.default.bool,
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   * @default undefined
   */
  height: import_prop_types34.default.number,
  /**
   * Indicate which axis to display the left of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default null
   */
  leftAxis: import_prop_types34.default.oneOfType([import_prop_types34.default.shape({
    axisId: import_prop_types34.default.oneOfType([import_prop_types34.default.number, import_prop_types34.default.string]),
    classes: import_prop_types34.default.object,
    disableLine: import_prop_types34.default.bool,
    disableTicks: import_prop_types34.default.bool,
   ...
   * @deprecated Consider using `slotProps.legend` instead.
   */
  legend: import_prop_types34.default.shape({
    classes: import_prop_types34.default.object,
   ...
   * @default object Depends on the charts type.
   */
  margin: import_prop_types34.default.shape({
    bottom: import_prop_types34.default.number,
    left: import_prop_types34.default.number,
    right: import_prop_types34.default.number,
    top: import_prop_types34.default.number
  }),
   ...
   * @default null
   */
  rightAxis: import_prop_types34.default.oneOfType([import_prop_types34.default.shape({
    axisId: import_prop_types34.default.oneOfType([import_prop_types34.default.number, import_prop_types34.default.string]),
    classes: import_prop_types34.default.object,
    disableLine: import_prop_types34.default.bool,
    disableTicks: import_prop_types34.default.bool,
  ...
  series: import_prop_types34.default.arrayOf(import_prop_types34.default.shape({
    arcLabel: import_prop_types34.default.oneOfType([import_prop_types34.default.oneOf(["formattedValue", "label", "value"]), import_prop_types34.default.func]),
    arcLabelMinAngle: import_prop_types34.default.number,
    arcLabelRadius: import_prop_types34.default.oneOfType([import_prop_types34.default.number, import_prop_types34.default.string]),
    color: import_prop_types34.default.string,
    cornerRadius: import_prop_types34.default.number,
    cx: import_prop_types34.default.oneOfType([import_prop_types34.default.number, import_prop_types34.default.string]),
    cy: import_prop_types34.default.oneOfType([import_prop_types34.default.number, import_prop_types34.default.string]),
    data: import_prop_types34.default.arrayOf(import_prop_types34.default.shape({
      color: import_prop_types34.default.string,
      id: import_prop_types34.default.oneOfType([import_prop_types34.default.number, import_prop_types34.default.string]),
      label: import_prop_types34.default.string,
      value: import_prop_types34.default.number.isRequired
    })).isRequired,
    endAngle: import_prop_types34.default.number,
    faded: import_prop_types34.default.shape({
      additionalRadius: import_prop_types34.default.number,
      arcLabelRadius: import_prop_types34.default.number,
      color: import_prop_types34.default.string,
      cornerRadius: import_prop_types34.default.number,
      innerRadius: import_prop_types34.default.number,
      outerRadius: import_prop_types34.default.number,
      paddingAngle: import_prop_types34.default.number
    }),
    highlighted: import_prop_types34.default.shape({
      additionalRadius: import_prop_types34.default.number,
      arcLabelRadius: import_prop_types34.default.number,
      color: import_prop_types34.default.string,
      cornerRadius: import_prop_types34.default.number,
    ...
    id: import_prop_types34.default.oneOfType([import_prop_types34.default.number, import_prop_types34.default.string]),
    innerRadius: import_prop_types34.default.oneOfType([import_prop_types34.default.number, import_prop_types34.default.string]),
    outerRadius: import_prop_types34.default.oneOfType([import_prop_types34.default.number, import_prop_types34.default.string]),
    paddingAngle: import_prop_types34.default.number,
    sortingValues: import_prop_types34.default.oneOfType([import_prop_types34.default.oneOf(["asc", "desc", "none"]), import_prop_types34.default.func]),
    startAngle: import_prop_types34.default.number,
    type: import_prop_types34.default.oneOf(["pie"]),
    valueFormatter: import_prop_types34.default.func
  })).isRequired,
  /**
   * If `true`, animations are skiped.
   * @default false
  ...
  tooltip: import_prop_types34.default.shape({
    axisContent: import_prop_types34.default.elementType,
    classes: import_prop_types34.default.object,
    itemContent: import_prop_types34.default.elementType,
    slotProps: import_prop_types34.default.object,
    slots: import_prop_types34.default.object,
    trigger: import_prop_types34.default.oneOf(["axis", "item", "none"])
  }),
  /**
   * Indicate which axis to display the top of the charts.
   * Can be a string (the id of the axis) or an object `ChartsXAxisProps`.
   * @default null
   */
  topAxis: import_prop_types34.default.oneOfType([import_prop_types34.default.shape({
    axisId: import_prop_types34.default.oneOfType([import_prop_types34.default.number, import_prop_types34.default.string]),
    classes: import_prop_types34.default.object,
    disableLine: import_prop_types34.default.bool,
    disableTicks: import_prop_types34.default.bool,
  ...
  viewBox: import_prop_types34.default.shape({
    height: import_prop_types34.default.number,
    width: import_prop_types34.default.number,
    x: import_prop_types34.default.number,
    y: import_prop_types34.default.number
  }),
  /**
   * The width of the chart in px. If not defined, it takes the width of the parent element.
   * @default undefined
   ...
   * If not provided, a default axis config is used with id set to `DEFAULT_X_AXIS_KEY`.
   */
  xAxis: import_prop_types34.default.arrayOf(import_prop_types34.default.shape({
    axisId: import_prop_types34.default.oneOfType([import_prop_types34.default.number, import_prop_types34.default.string]),
    classes: import_prop_types34.default.object,
    data: import_prop_types34.default.array,
    dataKey: import_prop_types34.default.string,
    disableLine: import_prop_types34.default.bool,
    disableTicks: import_prop_types34.default.bool,
    fill: import_prop_types34.default.string,
    hideTooltip: import_prop_types34.default.bool,
    id: import_prop_types34.default.oneOfType([import_prop_types34.default.number, import_prop_types34.default.string]),
    label: import_prop_types34.default.string,
    labelFontSize: import_prop_types34.default.number,
    labelStyle: import_prop_types34.default.object,
    max: import_prop_types34.default.oneOfType([import_prop_types34.default.instanceOf(Date), import_prop_types34.default.number]),
    min: import_prop_types34.default.oneOfType([import_prop_types34.default.instanceOf(Date), import_prop_types34.default.number]),
    position: import_prop_types34.default.oneOf(["bottom", "left", "right", "top"]),
    reverse: import_prop_types34.default.bool,
    scaleType: import_prop_types34.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types34.default.object,
    slots: import_prop_types34.default.object,
    stroke: import_prop_types34.default.string,
    tickFontSize: import_prop_types34.default.number,
   ...
   * If not provided, a default axis config is used with id set to `DEFAULT_Y_AXIS_KEY`.
   */
  yAxis: import_prop_types34.default.arrayOf(import_prop_types34.default.shape({
    axisId: import_prop_types34.default.oneOfType([import_prop_types34.default.number, import_prop_types34.default.string]),
    classes: import_prop_types34.default.object,
    data: import_prop_types34.default.array,
    dataKey: import_prop_types34.default.string,
...
function Scatter(props) {
  ...
  const cleanData = React54.useMemo(() => {
    const getXPosition = getValueToPositionMapper(xScale);
    const getYPosition = getValueToPositionMapper(yScale);
  ...
  return (0, import_jsx_runtime56.jsx)("g", {
    children: cleanData.map((dataPoint) => (0, import_jsx_runtime56.jsx)("circle", _extends({
      cx: 0,
      cy: 0,
      r: markerSize,
...
true ? Scatter.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "yarn proptypes"  |
  // ----------------------------------------------------------------------
  color: import_prop_types35.default.string.isRequired,
  markerSize: import_prop_types35.default.number.isRequired,
  series: import_prop_types35.default.shape({
    color: import_prop_types35.default.string.isRequired,
    data: import_prop_types35.default.arrayOf(import_prop_types35.default.shape({
      ...
      x: import_prop_types35.default.number.isRequired,
      y: import_prop_types35.default.number.isRequired
    })).isRequired,
    highlightScope: import_prop_types35.default.shape({
      faded: import_prop_types35.default.oneOf(["global", "none", "series"]),
      highlighted: import_prop_types35.default.oneOf(["item", "none", "series"])
    }),
    id: import_prop_types35.default.oneOfType([import_prop_types35.default.number, import_prop_types35.default.string]).isRequired,
    label: import_prop_types35.default.string,
    markerSize: import_prop_types35.default.number,
    type: import_prop_types35.default.oneOf(["scatter"]).isRequired,
    valueFormatter: import_prop_types35.default.func.isRequired,
    xAxisKey: import_prop_types35.default.string,
    yAxisKey: import_prop_types35.default.string
  }).isRequired,
  xScale: import_prop_types35.default.func.isRequired,
  yScale: import_prop_types35.default.func.isRequired
} : void 0;
...
function ScatterPlot(props) {
  ...
  const seriesData = React55.useContext(SeriesContext).scatter;
  const axisData = React55.useContext(CartesianContext);
  if (seriesData === void 0) {
    return null;
  }
  const {
  ...
  return (0, import_jsx_runtime57.jsx)(React55.Fragment, {
    children: seriesOrder.map((seriesId) => {
      const {
        id,
        xAxisKey,
      ...
      return (0, import_jsx_runtime57.jsx)(ScatterItems, _extends({
        xScale,
        yScale,
        color: color2,
...
var ScatterChart = React56.forwardRef(function ScatterChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
  ...
  return (0, import_jsx_runtime59.jsxs)(ResponsiveChartContainer, {
    ref,
    series: series.map((s2) => _extends({
      type: "scatter"
    }, s2)),
    ...
    children: [(0, import_jsx_runtime58.jsx)(ChartsAxis, {
      ...
      slots,
      slotProps
    }), (0, import_jsx_runtime58.jsx)(ScatterPlot, {
      slots,
      slotProps
    }), (0, import_jsx_runtime58.jsx)(ChartsLegend, _extends({}, legend, {
      slots,
      slotProps
    })), (0, import_jsx_runtime58.jsx)(ChartsAxisHighlight, _extends({
      x: "none",
      y: "none"
    }, axisHighlight)), (0, import_jsx_runtime58.jsx)(ChartsTooltip, _extends({
      trigger: "item"
    }, tooltip)), children]
  });
});
true ? ScatterChart.propTypes = {
   ...
   * @default xAxisIds[0] The id of the first provided axis
   */
  bottomAxis: import_prop_types37.default.oneOfType([import_prop_types37.default.shape({
   ...
   * @default yAxisIds[0] The id of the first provided axis
   */
  leftAxis: import_prop_types37.default.oneOfType([import_prop_types37.default.shape({
    axisId: import_prop_types37.default.oneOfType([import_prop_types37.default.number, import_prop_types37.default.string]),
    classes: import_prop_types37.default.object,
    disableLine: import_prop_types37.default.bool,
    disableTicks: import_prop_types37.default.bool,
   ...
   * @default null
   */
  rightAxis: import_prop_types37.default.oneOfType([import_prop_types37.default.shape({
    axisId: import_prop_types37.default.oneOfType([import_prop_types37.default.number, import_prop_types37.default.string]),
    classes: import_prop_types37.default.object,
    disableLine: import_prop_types37.default.bool,
    disableTicks: import_prop_types37.default.bool,
  ...
  series: import_prop_types37.default.arrayOf(import_prop_types37.default.shape({
    ...
    data: import_prop_types37.default.arrayOf(import_prop_types37.default.shape({
      ...
      x: import_prop_types37.default.number.isRequired,
      y: import_prop_types37.default.number.isRequired
    })).isRequired,
    highlightScope: import_prop_types37.default.shape({
      faded: import_prop_types37.default.oneOf(["global", "none", "series"]),
      highlighted: import_prop_types37.default.oneOf(["item", "none", "series"])
    }),
    id: import_prop_types37.default.oneOfType([import_prop_types37.default.number, import_prop_types37.default.string]),
    label: import_prop_types37.default.string,
    markerSize: import_prop_types37.default.number,
    type: import_prop_types37.default.oneOf(["scatter"]),
    valueFormatter: import_prop_types37.default.func,
    xAxisKey: import_prop_types37.default.string,
    yAxisKey: import_prop_types37.default.string
  })).isRequired,
  /**
   * The props used for each component slot.
   * @default {}
   ...
   * @default null
   */
  topAxis: import_prop_types37.default.oneOfType([import_prop_types37.default.shape({
    axisId: import_prop_types37.default.oneOfType([import_prop_types37.default.number, import_prop_types37.default.string]),
    classes: import_prop_types37.default.object,
    disableLine: import_prop_types37.default.bool,
    disableTicks: import_prop_types37.default.bool,
  ...
  xAxis: import_prop_types37.default.arrayOf(import_prop_types37.default.shape({
    ...
    position: import_prop_types37.default.oneOf(["bottom", "left", "right", "top"]),
...
var SparkLineChart = React57.forwardRef(function SparkLineChart2(props, ref) {
  const {
    xAxis,
    width,
    height,
    ...
    area,
    curve = "linear",
    skipAnimation: skipAnimation2 = false
  } = props;
  ...
  return (0, import_jsx_runtime61.jsxs)(ResponsiveChartContainer, {
    ref,
    series: [_extends({
      type: plotType,
      data,
    ...
    children: [plotType === "bar" && (0, import_jsx_runtime60.jsx)(BarPlot, {
      skipAnimation: skipAnimation2,
      slots,
      slotProps,
      sx: {
    ...
    }), plotType === "line" && (0, import_jsx_runtime61.jsxs)(React57.Fragment, {
      children: [(0, import_jsx_runtime60.jsx)(AreaPlot, {
        slots,
        slotProps
      }), (0, import_jsx_runtime60.jsx)(LinePlot, {
        slots,
        slotProps
      }), (0, import_jsx_runtime60.jsx)(LineHighlightPlot, {
        slots,
        slotProps
      })]
    }), (0, import_jsx_runtime60.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), showTooltip && (0, import_jsx_runtime60.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slotProps,
      slots
    })), children]
  });
...
true ? SparkLineChart.propTypes = {
   ...
   * @default false
   */
  area: import_prop_types38.default.bool,
   ...
   * @default 'linear'
   */
  curve: import_prop_types38.default.oneOf(["catmullRom", "linear", "monotoneX", "monotoneY", "natural", "step", "stepAfter", "stepBefore"]),
  /**
   * Data to plot.
   */
  data: import_prop_types38.default.arrayOf(import_prop_types38.default.number).isRequired,
  /**
   * An array of objects that can be used to populate series and axes data using their `dataKey` property.
   */
   ...
   * @default 'line'
   */
  plotType: import_prop_types38.default.oneOf(["bar", "line"]),
  /**
   ...
   * @default false
   */
  showHighlight: import_prop_types38.default.bool,
  /**
   * Set to `true` to enable the tooltip in the sparkline.
   * @default false
   */
  showTooltip: import_prop_types38.default.bool,
  /**
   ...
   */
  xAxis: import_prop_types38.default.shape({
